...
export default function Nav() {
  ...
  const navLinkClass = ({ isActive }) =>
    isActive
      ...
      : 'text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition duration-200';
    ...
    <header className="sticky top-0 z-50 bg-white dark:bg-gray-900 shadow-sm border-b dark:border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link 
            to="/" 
            className="text-2xl font-extrabold text-blue-600 dark:text-blue-400 flex items-center gap-2 hover:text-blue-700 dark:hover:text-blue-300 transition"
          >
            📚 TutorsTalk
          </Link>
        </div>
        ...
        <nav className="hidden lg:flex gap-8 items-center">
          ...
          <button 
            ...
            className="text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition duration-200 font-medium"
          >
            Add Tutorials
          </button>
          <button 
